...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "📂 *DEVIL TECH MD  V1 PLUGINS:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        if (m.quoted && m.quoted.key.fromMe) {
            ...
            if (/📂 \*DEVIL TECH MD  V1 PLUGINS:\*/i.test(quotedText)) {
        ...
        const statusMessage = {
            image: { url: `https://files.catbox.moe/4854y4.jpg` }, // Replace with your image URL
